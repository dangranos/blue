...
/proc/get_id_photo(var/mob/living/carbon/human/H, var/assigned_role)
	...
	if(use_species_tail)
		temp = new/icon('icons/effects/species.dmi', "[use_species_tail]_s")
		preview_icon.Blend(temp, ICON_OVERLAY)
	...
	var/icon/eyes = new/icon('icons/mob/human_face.dmi', use_eye_icon)
	...
	switch(assigned_role)
		if("Head of Personnel")
			clothes = new /icon('icons/mob/uniform.dmi', "hop")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
		if("Bartender")
			clothes = new /icon('icons/mob/uniform.dmi', "ba_suit")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Gardener")
			clothes = new /icon('icons/mob/uniform.dmi', "hydroponics")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Chef")
			clothes = new /icon('icons/mob/uniform.dmi', "chef")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Janitor")
			clothes = new /icon('icons/mob/uniform.dmi', "janitor")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Librarian")
			clothes = new /icon('icons/mob/uniform.dmi', "red_suit")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Quartermaster")
			clothes = new /icon('icons/mob/uniform.dmi', "qm")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
		if("Cargo Technician")
			clothes = new /icon('icons/mob/uniform.dmi', "cargotech")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Shaft Miner")
			clothes = new /icon('icons/mob/uniform.dmi', "miner")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Lawyer")
			clothes = new /icon('icons/mob/uniform.dmi', "internalaffairs")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
		if("Chaplain")
			clothes = new /icon('icons/mob/uniform.dmi', "chapblack")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
		if("Research Director")
			clothes = new /icon('icons/mob/uniform.dmi', "director")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/suit.dmi', "labcoat_open"), ICON_OVERLAY)
		if("Scientist")
			clothes = new /icon('icons/mob/uniform.dmi', "sciencewhite")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "white"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/suit.dmi', "labcoat_tox_open"), ICON_OVERLAY)
		if("Chemist")
			clothes = new /icon('icons/mob/uniform.dmi', "chemistrywhite")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "white"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/suit.dmi', "labcoat_chem_open"), ICON_OVERLAY)
		if("Chief Medical Officer")
			clothes = new /icon('icons/mob/uniform.dmi', "cmo")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/suit.dmi', "labcoat_cmo_open"), ICON_OVERLAY)
		if("Medical Doctor")
			clothes = new /icon('icons/mob/uniform.dmi', "medical")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "white"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/suit.dmi', "labcoat_open"), ICON_OVERLAY)
		if("Geneticist")
			clothes = new /icon('icons/mob/uniform.dmi', "geneticswhite")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "white"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/suit.dmi', "labcoat_gen_open"), ICON_OVERLAY)
		if("Virologist")
			clothes = new /icon('icons/mob/uniform.dmi', "virologywhite")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "white"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/suit.dmi', "labcoat_vir_open"), ICON_OVERLAY)
		if("Captain")
			clothes = new /icon('icons/mob/uniform.dmi', "captain")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
		if("Head of Security")
			clothes = new /icon('icons/mob/uniform.dmi', "hosred")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
		if("Warden")
			clothes = new /icon('icons/mob/uniform.dmi', "warden")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
		if("Detective")
			clothes = new /icon('icons/mob/uniform.dmi', "detective")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/suit.dmi', "detective"), ICON_OVERLAY)
		if("Security Officer")
			clothes = new /icon('icons/mob/uniform.dmi', "secred")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
		if("Chief Engineer")
			clothes = new /icon('icons/mob/uniform.dmi', "chief")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "brown"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/belt.dmi', "utility"), ICON_OVERLAY)
		if("Station Engineer")
			clothes = new /icon('icons/mob/uniform.dmi', "engine")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "orange"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/belt.dmi', "utility"), ICON_OVERLAY)
		if("Atmospheric Technician")
			clothes = new /icon('icons/mob/uniform.dmi', "atmos")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/belt.dmi', "utility"), ICON_OVERLAY)
		if("Roboticist")
			clothes = new /icon('icons/mob/uniform.dmi', "robotics")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
			clothes.Blend(new /icon('icons/mob/suit.dmi', "labcoat_open"), ICON_OVERLAY)
		else
			clothes = new /icon('icons/mob/uniform.dmi', "grey")
			clothes.Blend(new /icon('icons/mob/feet.dmi', "black"), ICON_UNDERLAY)
