	...
	if(nanoui_menu == 0)
		...
		for(var/datum/data/record/L in data_core.locked)
			if(L.fields["id"] == exploit_id)
				...
				nanoui_data["exploit"]["nanoui_exploit_record"] = L.fields["exploit_record"]
				nanoui_data["exploit"]["nanoui_exploit_record"] = replacetext(nanoui_data["exploit"]["nanoui_exploit_record"], "\n", "<br>")    // change line breaks into <br>
				nanoui_data["exploit"]["name"] =  L.fields["name"]
				nanoui_data["exploit"]["sex"] =  L.fields["sex"]
				nanoui_data["exploit"]["age"] =  L.fields["age"]
				nanoui_data["exploit"]["species"] =  L.fields["species"]
				nanoui_data["exploit"]["rank"] =  L.fields["rank"]
				nanoui_data["exploit"]["home_system"] =  L.fields["home_system"]
				nanoui_data["exploit"]["citizenship"] =  L.fields["citizenship"]
				nanoui_data["exploit"]["faction"] =  L.fields["faction"]
				nanoui_data["exploit"]["religion"] =  L.fields["religion"]
				nanoui_data["exploit"]["fingerprint"] = L.fields["fingerprint"]
				if(L.fields["antagvis"] == ANTAG_KNOWN || (faction == L.fields["antagfac"] && (L.fields["antagvis"] == ANTAG_SHARED)))
					nanoui_data["exploit"]["antagfaction"] = L.fields["antagfac"]
				else
					nanoui_data["exploit"]["antagfaction"] = "None"
