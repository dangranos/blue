...
//RECORD DELETE
			...
			if ("Add Entry")
				if (!( istype(active2, /datum/data/record) ))
					return
				var/a2 = active2
				var/t1 = trim(cp1251_to_utf8(sanitize(copytext(input("Add Comment:", "Secure. records", null, null)  as message,1,MAX_MESSAGE_LEN))))
...
//FIELD FUNCTIONS
			if ("Edit Field")
				...
				switch(href_list["field"])
					...
					if("id")
						if (istype(active2, /datum/data/record))
							var/t1 = trim(cp1251_to_utf8(sanitize(copytext(input("Please input id:", "Secure. records", active1.fields["id"], null)  as text,1,MAX_MESSAGE_LEN))))
							if (!t1 || active1 != a1)
								return
							active1.fields["id"] = t1
					if("fingerprint")
						if (istype(active1, /datum/data/record))
							var/t1 = trim(cp1251_to_utf8(sanitize(copytext(input("Please input fingerprint hash:", "Secure. records", active1.fields["fingerprint"], null)  as text,1,MAX_MESSAGE_LEN))))
							if (!t1 || active1 != a1)
								return
					...
					if("mi_crim")
						if (istype(active2, /datum/data/record))
							var/t1 = trim(cp1251_to_utf8(sanitize(copytext(input("Please input minor disabilities list:", "Secure. records", active2.fields["mi_crim"], null)  as text,1,MAX_MESSAGE_LEN))))
							if (!t1 || active2 != a2)
								return
							active2.fields["mi_crim"] = t1
					if("mi_crim_d")
						if (istype(active2, /datum/data/record))
							var/t1 = trim(cp1251_to_utf8(sanitize(copytext(input("Please summarize minor dis.:", "Secure. records", active2.fields["mi_crim_d"], null)  as message,1,MAX_MESSAGE_LEN))))
							if (!t1 || active2 != a2)
								return
							active2.fields["mi_crim_d"] = t1
					if("ma_crim")
						if (istype(active2, /datum/data/record))
							var/t1 = trim(cp1251_to_utf8(sanitize(copytext(input("Please input major diabilities list:", "Secure. records", active2.fields["ma_crim"], null)  as text,1,MAX_MESSAGE_LEN))))
							if (!t1 || active2 != a2)
								return
							active2.fields["ma_crim"] = t1
					if("ma_crim_d")
						if (istype(active2, /datum/data/record))
							var/t1 = trim(cp1251_to_utf8(sanitize(copytext(input("Please summarize major dis.:", "Secure. records", active2.fields["ma_crim_d"], null)  as message,1,MAX_MESSAGE_LEN))))
							if (!t1 || active2 != a2)
								return
							active2.fields["ma_crim_d"] = t1
					if("notes")
						if (istype(active2, /datum/data/record))
							var/t1 = trim(cp1251_to_utf8(sanitize(copytext(input("Please summarize notes:", "Secure. records", active2.fields["notes"], null)  as message,1,MAX_MESSAGE_LEN))))
							if (!t1 || active2 != a2)
								return
					...
					if("species")
						if (istype(active1, /datum/data/record))
							var/t1 = trim(cp1251_to_utf8(sanitize(copytext(input("Please enter race:", "General records", active1.fields["species"], null)  as message,1,MAX_MESSAGE_LEN))))
							if (!t1 || active1 != a1)
								return
