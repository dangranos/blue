...
/datum/category_item/player_setup_item/general/body/sanitize_character(var/savefile/S)
	if(!pref.species || !(pref.species in playable_species))
		pref.species = "Human"
	pref.hair_color		= sanitize_hexcolor(pref.hair_color, initial(pref.hair_color))
	pref.facial_color	= sanitize_hexcolor(pref.facial_color, initial(pref.facial_color))
	pref.s_tone			= sanitize_integer(pref.s_tone, -185, 34, initial(pref.s_tone))
	pref.skin_color		= sanitize_hexcolor(pref.skin_color, initial(pref.skin_color))
	pref.h_style		= sanitize_inlist(pref.h_style, hair_styles_list, initial(pref.h_style))
	pref.f_style		= sanitize_inlist(pref.f_style, facial_hair_styles_list, initial(pref.f_style))
	pref.eyes_color		= sanitize_hexcolor(pref.eyes_color, initial(pref.eyes_color))
...
/datum/category_item/player_setup_item/general/body/copy_to_mob(var/mob/living/carbon/human/character)
	...
	character.eyes_color   = pref.eyes_color
	character.h_style	   = pref.h_style
	character.hair_color   = pref.hair_color
	character.facial_color = pref.facial_color
	character.f_style	   = pref.f_style
	character.skin_color   = pref.skin_color
...
/datum/category_item/player_setup_item/general/body/content(var/mob/user)
	...
	. += "<br><b>Facial</b><br>"
	if(has_flag(mob_species, HAS_HAIR_COLOR))
		. += "<a href='?src=\ref[src];facial_color=1'>Change Color</a> <font face='fixedsys' size='3' color='[pref.facial_color]'><table  style='display:inline;' bgcolor='[pref.hair_color]'><tr><td>__</td></tr></table></font> "
	. += " Style: <a href='?src=\ref[src];facial_style=1'>[pref.f_style]</a><br>"

	if(has_flag(mob_species, HAS_EYE_COLOR))
		. += "<br><b>Eyes</b><br>"
		. += "<a href='?src=\ref[src];eye_color=1'>Change Color</a> <font face='fixedsys' size='3' color='[pref.eyes_color]'><table  style='display:inline;' bgcolor='[pref.hair_color]'><tr><td>__</td></tr></table></font><br>"

	if(has_flag(mob_species, HAS_SKIN_COLOR))
		. += "<br><b>Body Color</b><br>"
		. += "<a href='?src=\ref[src];skin_color=1'>Change Color</a> <font face='fixedsys' size='3' color='[pref.skin_color]'><table style='display:inline;' bgcolor='[pref.hair_color]'><tr><td>__</td></tr></table></font><br>"
	. = jointext(.,null)
