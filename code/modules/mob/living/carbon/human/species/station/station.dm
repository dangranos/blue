...
/datum/species/unathi
	...
	restricted_jobs = list("Captain", "Head of Personnel", "Security Commissioner", "Chief Engineer",\
						"Research Director", "Chief Medical Officer", "Brig Overseer", "Colonial Senior Officer", "Investigator", "Forensic Technician", "Colonial Officer",\
...
/datum/species/tajaran
	...
	restricted_jobs = list("Captain", "Head of Personnel", "Security Commissioner", "Chief Engineer",\
						"Research Director", "Chief Medical Officer", "Brig Overseer", "Investigator", "Forensic Technician", "Colonial Officer", "Colonial Senior Officer",\
