/spell/targeted/equip_item/party_hardy
	...
	equipped_summons = list("active hand" = /obj/item/weapon/reagent_containers/glass/drinks/bottle/small/beer)
...
/spell/targeted/equip_item/party_hardy/empower_spell()
	...
	switch(spell_levels[Sp_POWER])
		...
		if(2)
			equipped_summons = list("active hand" = /obj/item/weapon/reagent_containers/glass/drinks/bottle/absinthe,
								"off hand" = /obj/item/weapon/reagent_containers/food/snacks/poppypretzel,
