...
/* //RESOMI - TODO: make something for Teshari
...
/* //VOX - no vox on polaris.. maybe later
...
/spell/moghes_blessing/choose_targets(mob/living/user = usr)
	var/list/hands = list()
...
/* //IPC TODO: do we even have those at all?
