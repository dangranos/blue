...
/obj/item/weapon/reagent_containers/glass/beaker/bottle/eznutrient
	name = "\improper EZ NUtrient bottle"
	desc = "A small bottle."
	icon_state = "bottle-4"
	preloaded = list("eznutrient" = 60)

/obj/item/weapon/reagent_containers/glass/beaker/bottle/left4zed
	name = "\improper Left-4-Zed bottle"
	desc = "A small bottle."
	icon_state = "bottle-4"
	preloaded = list("left4zed" = 60)

/obj/item/weapon/reagent_containers/glass/beaker/bottle/robustharvest
