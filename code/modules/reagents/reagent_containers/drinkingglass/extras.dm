/obj/item/weapon/reagent_containers/glass/drinking/attackby(obj/item/I as obj, mob/user as mob)
...
/obj/item/weapon/reagent_containers/glass/drinking/attack_hand(mob/user as mob)
